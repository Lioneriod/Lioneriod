...
I'm an extroverted Full-Stack Developer and Systems Creator from Brazil. With a dual background in **Systems Analysis and Development** and **Architecture and Urbanism**, I do my best to connect logical backend architecture with beautiful, human-centric design. 

Most of my web engineering expertise comes from the rigorous **The Odin Project** curriculum, which was a great experience for me since it focused a lot in deep-dive problem solving, clean code patterns, and test-driven development.

---

### 🌐 What I Do
*   **Full-Stack Development:** Building seamless applications from database to UI.
*   **Systems Architecture:** Designing robust APIs, structural data flows, and relational databases.
*   **Design & UX Thinking:** Applying spatial logic and architectural design principles to digital interfaces.
...
*   🌱 **Gardening:** - Thinking of ways to automate and monitor this one
*   🎮 **Games:** - The usual
*   🤓 **Anime:** - I love you, Subaru
*   🌟 **NAS/Home Lab:** - Lots of file organizing and customizing
